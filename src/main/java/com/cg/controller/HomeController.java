...
public class HomeController {
	...
	public String login(@RequestBody CustomerDetails c) {
		accountNo = bank.login(c);
		return "Login Succesful done!";
	...
	public ResponseEntity fundTransfer(@RequestBody TransactionDetails transaction) {
		int amount = 0;
		if(accountNo != 0) {
